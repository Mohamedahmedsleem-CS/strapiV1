...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quantity_options: Schema.Attribute.Relation<
      'oneToMany',
      'api::quantity-option.quantity-option'
    >;
    reviewImages: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usageMethods: Schema.Attribute.Blocks;
    warnings: Schema.Attribute.Blocks;
    whatsIncluded: Schema.Attribute.Text;
  };
}

export interface ApiQuantityOptionQuantityOption
  extends Struct.CollectionTypeSchema {
  collectionName: 'quantity_options';
  info: {
    displayName: 'Quantity Option';
    pluralName: 'quantity-options';
    singularName: 'quantity-option';
  };
  options: {
    draftAndPublish: true;
  };
